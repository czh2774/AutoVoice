...
class FootballWealthUser(models.Model):
    ...
    poster = models.CharField(max_length=255, null=True, blank=True, verbose_name='头像')
...
class FootballWealthRecommend(models.Model):
    ...
    away = models.CharField(verbose_name='客队名称', max_length=255, null=True, blank=True)  # "away":"鹿岛鹿角"
    awayScore = models.CharField(verbose_name='客队比分', max_length=255, null=True, blank=True)  # "awayScore":"3"
    bd_yz_hjspl = models.CharField(verbose_name='北单_yz_hjspl', max_length=255, null=True,
    ...
    bd_yz_hjspl_str = models.CharField(verbose_name='北单_yz_hjspl_str', max_length=255, null=True,
                                       blank=True)  # 'bd_yz_hjspl_str': '主让0.5'
    bd_yz_jspk = models.CharField(verbose_name='北单_yz_jspk', max_length=255, null=True,
                                  blank=True)  # 'bd_yz_jspk': '-0.5'
    bd_yz_result = models.IntegerField(verbose_name='北单_yz_结果', null=True, blank=True)  # 'bd_yz_result': 2
    bd_yz_rr = models.CharField(verbose_name='北单_yz_rr', max_length=255, null=True, blank=True)  # 'bd_yz_rr': '0'
    bd_yz_sr = models.CharField(verbose_name='北单_yz_胜率？', max_length=255, null=True, blank=True)  # 'bd_yz_sr': '0'
    bd_yz_wjspl = models.CharField(verbose_name='北单_yz_wjspl', max_length=255, null=True,
    ...
    bd_yz_wjspl_str = models.CharField(verbose_name='亚盘盘口？', max_length=255, null=True,
    ...
    check_rr = models.CharField(verbose_name='check_rr', max_length=255, null=True, blank=True)  # 'check_rr': '0.00'
    check_sr = models.CharField(verbose_name='check_sr', max_length=255, null=True, blank=True)  # 'check_sr': '0.00'
    comment_id = models.IntegerField(verbose_name='评论ID', null=True, blank=True)  # "comment_id":1738867
    create_time = models.CharField(verbose_name='推荐比赛时间', max_length=255, null=True,
                                   blank=True)  # "create_time":1567568901549
    dxq_desc = models.CharField(verbose_name='大小球_desc', max_length=255, null=True, blank=True)  # 'dxq_desc': '大小球'
    dxq_hjspl = models.CharField(verbose_name='大小球_hjspl', max_length=255, null=True, blank=True)  # 'dxq_hjspl': '0.83'
    ...
    dxq_hjspl_str = models.CharField(verbose_name='大小球_hjspl_str', max_length=255, null=True,
                                     blank=True)  # 'dxq_hjspl_str': '大2.50'
    dxq_is_end = models.IntegerField(verbose_name='大小球_is_end', null=True, blank=True)  # 'dxq_is_end': 1
    dxq_jspk = models.CharField(verbose_name='大小球_jspk', max_length=255, null=True, blank=True)  # 'dxq_jspk': '2.50'
    dxq_result = models.IntegerField(verbose_name='大小球_结果', null=True, blank=True)  # 'dxq_result': 0
    dxq_rr = models.CharField(verbose_name='大小球_rr', max_length=255, null=True, blank=True)  # 'dxq_rr': '0'
    dxq_sr = models.CharField(verbose_name='大小球_胜率', max_length=255, null=True, blank=True)  # 'dxq_sr': '0'
    dxq_wjspl = models.CharField(verbose_name='大小球_wjspl', max_length=255, null=True, blank=True)  # 'dxq_wjspl': '1.03'
    ...
    dxq_wjspl_str = models.CharField(verbose_name='大小球_wjspl_str', max_length=255, null=True,
    ...
    home = models.CharField(verbose_name='主队名称', max_length=255, null=True, blank=True)  # "home":"浦和红钻"
    homeScore = models.CharField(verbose_name='主队比分', max_length=255, null=True, blank=True)  # "homeScore":"2"
    id = models.IntegerField(primary_key=True, verbose_name='推荐ID')
    ID_bet007 = models.CharField(verbose_name='ID_bet007', max_length=255, null=True,
    ...
    league = models.CharField(verbose_name='比赛日期', max_length=255, null=True, blank=True)  # "league":"日联杯"
    letball = models.CharField(verbose_name='让球', max_length=255, null=True, blank=True)  # "letball":"让球"
    match_id = models.CharField(verbose_name='比赛场次', max_length=255, null=True, blank=True)  # "match_id":"周三002"
    match_time1 = models.CharField(verbose_name='比赛日期', max_length=255, null=True, blank=True)  # 'match_time1': '09/04'
    match_time2 = models.CharField(verbose_name='比赛小时', max_length=255, null=True, blank=True)  # 'match_time2': '02:45'
    MatchTimeStamp = models.CharField(verbose_name='比赛时间',max_length=255, null=True, blank=True, )  # "MatchTimeStamp":1567593000000
    ...
    rq_goal = models.CharField(verbose_name='让球数', max_length=255, null=True, blank=True)  # "rq_goal":"+1"
    rq_rq0 = models.CharField(verbose_name='让球负赔率', max_length=255, null=True, blank=True)  # "rq_rq0":"4.30"
    ...
    rq_rq1 = models.CharField(verbose_name='让球平赔率', max_length=255, null=True, blank=True)  # "rq_rq1":"3.80"
    ...
    rq_rq3 = models.CharField(verbose_name='让球胜赔率', max_length=255, null=True, blank=True)  # "rq_rq3":"1.51"
    ...
    rq_sf_rr = models.CharField(verbose_name='让球胜率', max_length=255, null=True, blank=True)  # "rq_sf_rr":"0"
    rq_sf_sr = models.CharField(verbose_name='让球胜率', max_length=255, null=True, blank=True)  # "rq_sf_sr":"100.00"
    rr = models.CharField(verbose_name='rr', max_length=255, null=True, blank=True)  # 'rr': '0'
    sf_goal = models.CharField(verbose_name='胜平负让球数', max_length=255, null=True, blank=True)  # "sf_goal":"0"
    sf_sf0 = models.CharField(verbose_name='胜平负负', max_length=255, null=True, blank=True)  # "sf_sf0":"2.10"
    ...
    sf_sf1 = models.CharField(verbose_name='胜平负平赔率', max_length=255, null=True, blank=True)  # "sf_sf1":"3.35"
    ...
    sf_sf3 = models.CharField(verbose_name='胜平负胜赔率', max_length=255, null=True, blank=True)  # "sf_sf3":"2.60"
    ...
    spf_goal = models.CharField(verbose_name='胜平负_goal', max_length=255, null=True, blank=True)  # 'spf_goal': '0'
    spf_result = models.IntegerField(verbose_name='胜平负结果', null=True, blank=True)  # 'spf_result': 0
    spf_rr = models.CharField(verbose_name='胜平负胜率', max_length=255, null=True, blank=True)  # 'spf_rr': '0'
    spf_sf0 = models.CharField(verbose_name='胜平负_负', max_length=255, null=True, blank=True)  # 'spf_sf0': '无'
    ...
    spf_sf1 = models.CharField(verbose_name='胜平负_平', max_length=255, null=True, blank=True)  # 'spf_sf1': '无'
    ...
    spf_sf3 = models.CharField(verbose_name='胜平负_胜', max_length=255, null=True, blank=True)  # 'spf_sf3': '无'
    ...
    spf_sr = models.CharField(verbose_name='胜平负_胜率', max_length=255, null=True, blank=True)  # 'spf_sr': '0'
    sr = models.CharField(verbose_name='胜率sr', max_length=255, null=True, blank=True)  # 'sr': '0'
    ...
    yz_desc = models.CharField(verbose_name='亚盘玩法？', max_length=255, null=True, blank=True)  # 'yz_desc': '亚盘'
